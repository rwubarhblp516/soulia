...
class Styles {
  ...
  static TextStyle style_9F9EA6_11 = TextStyle(
      color: const Color(0xff9F9EA6), fontSize: 11.sp, height: 1.1.sh);
  static TextStyle style_9F9EA6_14 = TextStyle(
      color: const Color(0xff9F9EA6), fontSize: 14.sp, height: 1.1.sh);
  static TextStyle style_616169_11 = TextStyle(
      color: const Color(0xff616169), fontSize: 11.sp, height: 1.1.sh);

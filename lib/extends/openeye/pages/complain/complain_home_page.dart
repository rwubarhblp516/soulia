...
import 'package:soulia/extends/openeye/pages/complain/widget/item_common_question_widget.dart';
import 'package:soulia/extends/openeye/res/colors.dart';
import 'package:soulia/extends/openeye/res/strings.dart';
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Image.asset(
              position == 0
                  ? "assets/openeye_images/images/icon_submit_question.png"
                  : "assets/openeye_images/images/icon_my_feedback.png",
              height: 50.w,
              width: 50.w,
            ),
            Box.wBox16,
            ...
            GestureDetector(
              child: RichText(
                  text: TextSpan(
                    ...
                    TextSpan(
                        text: "950496",
                        style: TextStyle(color: ColorStyle.color_black_80)),
                  ])),
              onTap: () {
                launch("tel://950496");
              },

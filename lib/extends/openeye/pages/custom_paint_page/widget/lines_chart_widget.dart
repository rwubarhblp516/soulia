...
import 'package:soulia/extends/openeye/pages/custom_paint_page/painter/horizental_line_chart_painter.dart';
...
class LinesChartWidget extends CommonStatefulWidget {
  ...
  const LinesChartWidget(this.dataList, {Key? key}) : super(key: key);

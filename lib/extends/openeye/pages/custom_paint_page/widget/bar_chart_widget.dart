...
import 'package:soulia/extends/openeye/pages/custom_paint_page/painter/bar_chart_painter.dart';
import 'dart:ui' as ui;

class BarChartWidget extends CommonStatefulWidget {
  List<double> barList;

  BarChartWidget(this.barList, {Key? key}) : super(key: key);
...
class BarChartState extends State<BarChartWidget> {
  ...
  void initState() {
    super.initState();
    // LogE(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>初始状态msg");
    load("assets/openeye_images/images/icon_text_tag.png").then((value) {

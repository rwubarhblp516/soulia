...
import 'package:soulia/db/completion_dao.dart';
import 'package:soulia/db/favorite_dao.dart';
import 'package:soulia/db/hi_db_manager.dart';
...
import 'package:soulia/widget/message_input_widget.dart';
...
class _ConversationPageState extends State<ConversationPage> {
  ...
  String get _title => _sendBtnEnable ? 'Soulia' : '我想想怎么回复你呢...';
  ...
  void _doInit() async {
    try {
      ...
      userInfo = {
        'avatar':
            'https://tse4-mm.cn.bing.net/th/id/OIP-C.vSgfeOcSdzX1UH4iKzpCFgHaHV?rs=1&pid=ImgDetMain',
        'userName': '测试账号',
        'souliaId': '0'
      };
    }
